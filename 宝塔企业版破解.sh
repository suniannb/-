...
downloads_Url=http://zhujiwo.net/LinuxPanel
setup_path=/www
version=$(curl -Ss --connect-timeout 5 -m 2 https://versions.fenhao.me/api/panel/get_version)
if [ "$version" = '' ];then
	version='7.5.2'
fi

wget -T 5 -O /tmp/panel.zip $downloads_Url/LinuxPanel-${version}.zip
...
echo -e "\033[31m官方交流QQ群：976935527 \033[0m"
